...
public class MainController {
	...
	private final MainService service; // 서비스 의존성 주입 DI -> RequiredArgsConstructor 때문에
	...
	@ResponseBody
	@PostMapping("resetPw")
	public int resetPw(@RequestBody int memberNo) { // 비밀번호 update 이므로 int
