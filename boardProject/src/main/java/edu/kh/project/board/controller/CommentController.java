...
@RestController 
// @Controller + @ResponseBody 둘 합친 것
// 비동기 요청 처리 전용 컨트롤러
...
public class CommentController {
	...
	/** 댓글 등록
	 * @param comment : 요청 시 body 에 JSON 형태로 담겨져 제출된 데이터를 
	 * HttpMessageConverter가 DTO로 변환한 객체 (boardNo, commentContent, parentCommentNo)
